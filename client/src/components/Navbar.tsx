        ...
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="hidden md:flex items-center gap-2">
            <button
              ...
              className="px-3.5 py-1.5 rounded-full bg-linear-to-r from-rose-500 to-pink-500 hover:from-rose-600 hover:to-pink-600 text-white text-xs font-bold shadow-md shadow-rose-200 transition flex items-center gap-1.5 active:scale-95"
            >
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="relative w-9 h-9 sm:w-10 sm:h-10 rounded-full overflow-hidden border-2 border-rose-400 shadow-sm hover:scale-105 transition shrink-0"
              title="Edit Profile"
            >
              <img
